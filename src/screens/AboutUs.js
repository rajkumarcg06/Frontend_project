...
const AboutUs=() => {
    return(
        <>
        <div className="abt">
            <p><h2 style={{color:'orange',fontWeight:'600'}}>Vision</h2><br/>To become an outstanding Technological University at the cutting
        ...
        <div className="abt">
            ...
            <p><h2 style={{color:'orange',fontWeight:'600'}}>Mission</h2><br/>To plan the development of technical education, to establish
        ...
        <div className="abt">
            <p><h2 style={{color:'orange',fontWeight:'600'}}>Mandate</h2><br/>The Visvesvaraya Technological University has 
